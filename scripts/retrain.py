...
subfolders, each full of images for each label. The example folder downloads
should have a structure like this:

~/downloads/daisy/photo1.jpg
~/downloads/daisy/photo2.jpg
...
~/downloads/rose/anotherphoto77.jpg
...
~/downloads/sunflower/somepicture.jpg
...
```bash
python tensorflow/examples/image_retraining/retrain.py \
    --image_dir ~/downloads --architecture mobilenet_1.0_224
```
